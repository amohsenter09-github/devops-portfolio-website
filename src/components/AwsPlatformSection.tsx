...
export default function AwsPlatformSection() {
  return (
    <section className="py-20 bg-white w-full">
      {/* ===== HEADER + DESCRIPTION ===== */}
      <div className="max-w-3xl mx-auto text-center px-4 sm:px-6 lg:px-8 w-full">
      ...
      {/* ===== DIAGRAM CARD ===== */}
      <div className="max-w-7xl mx-auto mt-14 px-4 sm:px-6 lg:px-8 w-full">
      ...
      {/* ===== SECTION DIVIDER ===== */}
      <div className="max-w-5xl mx-auto my-20 px-4 sm:px-6 lg:px-8 border-t border-gray-200" />
    </section>
  );
}
