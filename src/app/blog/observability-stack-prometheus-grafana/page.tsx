      ...
      <article className="pb-16 w-full">
        <div className="max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="bg-white rounded-xl border border-gray-200 p-6 md:p-8 mb-16 shadow-sm hover:shadow-md transition-shadow duration-300"
          >
            <h2 className="text-lg md:text-xl font-bold mb-5 text-gray-900">My Solution</h2>
            <div className="space-y-3 text-sm md:text-base text-gray-700 leading-relaxed">
              <p>
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-base md:text-lg font-semibold mb-3 text-gray-900 flex items-center">
