...
import { ArrowLeft, Calendar, Clock, Tag, Code, Server } from "lucide-react";
...
export default function ObservabilityStackPost() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-100">
      ...
      <section className="py-12 md:py-16 w-full flex items-center justify-center">
        <div className="max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="font-mono text-xl md:text-2xl font-semibold mb-5 text-gray-900 leading-tight">
      ...
      <article className="pb-12 w-full flex items-center justify-center">
        <div className="max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="bg-white rounded-xl border border-gray-200 p-6 md:p-8 mb-16 shadow-sm hover:shadow-md transition-shadow duration-300"
          >
            <h2 className="text-lg md:text-xl font-bold mb-5 text-gray-900">The Challenge</h2>
          ...
          <motion.div
            ...
            className="bg-white rounded-xl border border-gray-200 p-6 md:p-8 mb-16 shadow-sm hover:shadow-md transition-shadow duration-300"
          >
            <h2 className="text-lg md:text-xl font-bold mb-5 text-gray-900 flex items-center">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <div className={`w-2.5 h-2.5 ${item.colorClass} rounded-full`}></div>
                      <span className="font-medium text-sm md:text-base text-white">{item.label}</span>
                    </div>
                    <span className="text-xs md:text-sm text-gray-400">{item.tech}</span>
                  </motion.div>
                ))}
              </div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8">
              <div>
                <h3 className="text-base md:text-lg font-semibold mb-3 text-gray-900">Prometheus Configuration</h3>
              ...
              <div>
                <h3 className="text-base md:text-lg font-semibold mb-3 text-gray-900">Grafana Dashboards</h3>
                <ul className="space-y-2 text-sm md:text-base text-gray-600">
          ...
          <motion.div
            ...
            className="bg-white rounded-xl border border-gray-200 p-6 md:p-8 mb-16 shadow-sm hover:shadow-md transition-shadow duration-300"
          >
            <h2 className="text-lg md:text-xl font-bold mb-5 text-gray-900">Results Achieved</h2>
