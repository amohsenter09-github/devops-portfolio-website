...
export default function About() {
  return (
    <div className="w-full min-h-screen bg-white">
      {/* Hero Section */}
      <section className="pt-64 md:pt-72 lg:pt-80 pb-24 md:pb-32 flex flex-col items-center justify-center bg-gradient-to-b from-gray-50 via-white to-gray-100 text-center">
        <motion.div
        ...
        >
          <div className="space-y-6 text-gray-700 text-lg leading-relaxed" style={{ marginTop: '3rem' }}>
            <p>
              I&apos;m{" "}
