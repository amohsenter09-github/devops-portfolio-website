          ...
          <div className="space-y-8">
            {caseStudies.map((study, index) => (
              <motion.div
                ...
                className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-8"
              >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white/50 dark:bg-gray-800/50 rounded-lg p-3 text-center">
                        <div className="text-sm text-gray-600 dark:text-gray-300">Project Value</div>
                        <div className="text-lg font-bold text-gray-900 dark:text-white">{study.projectValue}</div>
                      </div>
                      <div className="bg-white/50 dark:bg-gray-800/50 rounded-lg p-3 text-center">
                        <div className="text-sm text-gray-600 dark:text-gray-300">ROI</div>
                        <div className="text-lg font-bold text-green-600 dark:text-green-400">{study.roi}</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-blue-900/20 border border-gray-200 dark:border-gray-700 rounded-lg p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Proven ROI</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Rapid Delivery</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
